                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-1 p-1 rounded-lg bg-gray-200 dark:bg-gray-700">
                                                <button
                                                    ...
                                                    className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm transition-colors ${!isDarkMode
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                />
                                                <span
                                                    className={`text-sm font-mono px-2 py-1 rounded ${isDarkMode ? "bg-gray-700" : "bg-gray-200"
                                                        }`}
                                                >
