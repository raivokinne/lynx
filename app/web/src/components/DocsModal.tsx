...
import { Wrench, Book, Package, Shield, Code, Languages } from "lucide-react";
...
import { BuiltinsSection } from "./docs/BuiltinsSection";
...
export const DocsModal = ({ isDarkMode, onClose }: DocsModalProps) => {
  ...
  const renderContent = () => {
    ...
    switch (activeSection) {
      ...
      case "builtins":
        return <BuiltinsSection isDarkMode={isDarkMode} />;
      case "stdlib":
