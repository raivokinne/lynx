				...
				<div className="space-y-2">
					...
					<div className="grid grid-cols-1 gap-2">
						{builtInThemes.map((theme) => (
							<div
								key={theme.id}
								className={`flex items-center justify-between p-3 border rounded transition-colors ${editorSettings.theme === theme.id
										? isDarkMode
							...
							>
								...
								<div className="flex items-center gap-2">
									...
									<button
										...
										className={`px-3 py-1 text-sm rounded transition-colors ${editorSettings.theme === theme.id
