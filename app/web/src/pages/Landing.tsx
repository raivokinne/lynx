...
const features = [
	{
		title: "Clean Syntax",
		description: "No unnecessary parentheses in control structures, minimal punctuation, and intuitive operators.",
	},
	{
		title: "Functional Programming",
		description: "First-class functions, closures, higher-order functions, and powerful pipeline operators.",
	},
	{
		title: "Immutable by Default",
		description: "Arrays and strings are immutable, promoting safer concurrent programming and easier reasoning.",
	},
	{
		title: "Pattern Matching",
		description: "Elegant destructuring and matching capabilities for complex data handling.",
	},
];
		...
		<div className="min-h-screen bg-black text-neutral-300 font-mono">
			...
			<section className="pt-24 pb-16 px-4">
				<div className="max-w-3xl mx-auto text-center">
					...
					<p className="text-sm text-neutral-500 mb-10 max-w-xl mx-auto">
						clean, minimal, and focused on simplicity. write expressive code without
			...
			<section className="py-16 px-4 border-t border-neutral-800">
				<div className="max-w-xl mx-auto text-center">
					<h2 className="text-lg font-bold mb-4 text-white">ready to try lynx?</h2>
					<p className="text-xs text-neutral-500 mb-8">
						start writing clean, expressive code in seconds. no installation required.
					</p>
					<Link
						to="/editor"
