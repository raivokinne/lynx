...
// Get user's overall execution history
...
// Get execution statistics for a code
...
// Get user's overall execution statistics
export const getUserExecutionStats = async (req, res) => {
  try {
    ...
    // Get executions per day for the last 30 days
...
// Delete execution history for a code
...
// Cleanup old execution history (keep only last N days)
