...
// It returns the first row, or an error if the query fails.
...
// It returns the rows, or an error if the query fails.
...
// Exec executes a query that is expected to return no rows.
// It returns the result, or an error if the query fails.
